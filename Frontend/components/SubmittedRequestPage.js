...
function SubmittedRequests({ navigation }) {
  ...
  const backendURL = "http://192.168.0.1885000/uploads/";
  ...
  const fetchHelpRequests = async () => {
    try {
      const response = await fetch('http://192.168.0.188:5000/api/help');
  ...
  const handleReply = async (requestId) => {
    ...
    try {
      const response = await fetch(`http://192.168.0.188:5000/api/help/reply/${requestId}`, {
        method: 'POST',
